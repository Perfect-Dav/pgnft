      ...
      "
            ...
            >
                ...
                <div id="bgimage" class="absolute top-0 w-full h-full bg-left bg-cover" >
                    <div class="bgimagetop">
                        <img src="/config/images/face_top.png" class="" />
                    </div>
                    <div class="bgimagebot">
                        <img src="/config/images/face_bottom.png" class="" />
                    </div>
                </div>
                                            ...
                                            {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
                                                ...
                                                <>
                                                    ...
                                                    >
                                                        ...
                                                        1 Strange Pig will cost {CONFIG.DISPLAY_COST}{" "}
                                                    ...
                                                    {blockchain.account === "" ||
                                                        ...
                                                        <s.Container ai={"center"} jc={"center"}>
                                                            ...
                                                            >
                                                                On the {CONFIG.NETWORK.NAME} Network
            ...
            <section class="pt-20 pb-20 bg-gray-700 -mt-0">
              ...
              "
                            ...
                            >
                                1,080 Potluck Pigs have returned after being abducted by the Strange Ones..... No one could have imagined this....
                            </p>
                        </div>
        ...
        "
                ...
                "
                                ...
                                <p class="mt-4 text-lg leading-relaxed text-gray-200">
                                    The Strange Pigs have been returned to the FTM Network!
                                    There are 1,080 of the Strange Pigs available, so get them before they
                                    are gone! And at 35 FTM each, they will go FAST!
                                </p>
                        ...
                        "
                            ...
                            <p class="mt-12 text-lg leading-relaxed text-gray-200">
                                Make sure you snag a Strange Pig!
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                ...
                                <div class="pt-6 text-center">
                                    <h5 class="text-xl font-bold text-gray-400">Dracula Pressley</h5>
                        ...
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                ...
                                />
                                <div class="pt-6 text-center">
                                    <h5 class="text-xl font-bold text-gray-400">TrueVoodoo</h5>
                                    <p class="mt-1 text-sm text-gray-200 uppercase font-semibold">
                        ...
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                ...
                                />
                                <div class="pt-6 text-center">
                                    <h5 class="text-xl font-bold text-gray-400">Tinfoil Realist</h5>
                                    <p class="mt-1 text-sm text-gray-200 uppercase font-semibold">
                                        Ambassador of Alpha
                                    </p>
                                    <div class="mt-6"></div>
                        ...
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                ...
                                />
                                <div class="pt-6 text-center">
                                    <h5 class="text-xl font-bold text-gray-400">Plot Twist</h5>
                                    <p class="mt-1 text-sm text-gray-200 uppercase font-semibold">
                                        The Go To Guy
                                    </p>
                                    <div class="mt-6"></div>
